...
private val mapControllerViewerGetSlots = Semaphore(NETWORK_HANDLER_CONCURRENCY)
private val mapControllerDetailGetSlots = Semaphore(NETWORK_HANDLER_CONCURRENCY)
private val beatmapControllerRedirectOldGetSlots = Semaphore(NETWORK_HANDLER_CONCURRENCY)
...
fun Route.mapController() {
    ...
    get<MapController.Viewer> {
        mapControllerViewerGetSlots.withPermit {
    ...
    get<MapController.Detail> { req ->
        mapControllerDetailGetSlots.withPermit {
            val sess = call.sessions.get<Session>()
    ...
    get<BeatmapController.RedirectOld> {
        beatmapControllerRedirectOldGetSlots.withPermit {
            try {
                transaction {
                    modelPostgresOperation()
